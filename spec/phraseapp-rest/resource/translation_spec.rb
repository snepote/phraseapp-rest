...
RSpec.describe Phraseapp::Rest::Resource::Translation do
  ...
  it 'returns one translation for the given id' do
    ...
    translation = subject.get(id: 'abcd1234cdef1234abcd1234cdef1234').body
  ...
  it 'returns a list of translatons filtered by locale' do
    allow(api).to receive(:get)
      ...
      .and_return(ApiClientMock.resource(resource_type, 'list_by_locale.json'))
    expect(subject.list_by_locale(locale_id: locale_id).body.count).to eq 2
  end
end
